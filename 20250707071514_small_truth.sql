...
BEGIN
  ...
  -- Drop existing policies for restaurant_tables table
  DROP POLICY IF EXISTS "Anyone can read restaurant tables" ON restaurant_tables;
  DROP POLICY IF EXISTS "Admin can manage all tables" ON restaurant_tables;
END $$;
...
-- Create policies for restaurant_tables table
